...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      name: "lifecycle",
      testMatch:
        /(atmosphere-lifecycle|picture-weight|inline-editing|shared-viewer|live-demo|presenter-camera|recording-quality|deck-export|reference-read|composition|camera-flight|editor|editor-narrow|dialog-focus|hand-mark|presenter-stage|presenter-console|dashboard|notes|picture-drift)\.spec\.ts/,
      use: {
        ...devices["Desktop Chrome"],
        launchOptions: {
          executablePath,
