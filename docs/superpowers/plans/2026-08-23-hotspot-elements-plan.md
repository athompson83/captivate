...
- Create: `supabase/migrations/0009_scene_flow_role.sql`
...
```bash
git add src/lib/schema/presentation.ts src/lib/data/presentations.ts supabase/migrations/0009_scene_flow_role.sql tests/unit/presentation-schema.test.ts
