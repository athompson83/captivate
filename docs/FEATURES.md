...
| A room per movement                    | Implemented | A movement can stand in a room of its own, chosen beside its name; the show stands in it on that movement's scenes and establishing shot, crossfading on the same plane, and in the show's room elsewhere and from the overview; the export and the share resolver carry it       |
